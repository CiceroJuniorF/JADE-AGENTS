...
public class ProductRepository {
    ...
    public HashMap<String, List<Product>> getAllproducts(){
        ...
        product = new Product("Arroz", "Tio João", new BigDecimal("15.00"));
        list.add(product);
        
        product = new Product("Feijão", "Kicaldo", new BigDecimal("10.00"));
        list.add(product);
        product =  new Product("Açucar", "Cristal", new BigDecimal("4.00"));
        list.add(product);
        ...
        //Adicionando Valor para merchant-carrefour
        product = new Product("Arroz", "Tio João", new BigDecimal("5.00"));
        list.add(product);
        product = new Product("Feijão", "Kicaldo", new BigDecimal("20.00"));
        list.add(product);
        product =  new Product("Açucar", "Cristal", new BigDecimal("10.00"));
        list.add(product);        
        //Adiciona a lista de produto para o respectivo vendedor
        ...
        //Adicionando Valor para merchant-carrefour
        product = new Product("Arroz", "Tio João", new BigDecimal("100.00"));
        list.add(product);
        product = new Product("Paçoca", "Paçoquita", new BigDecimal("2.00"));
        list.add(product);
